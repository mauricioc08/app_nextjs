    ...
    <section className="experiencia" id="experiencia" aria-label="Experiência">
      ...
      <div className="carousel">
        <p className="experiencia-texto">
          Desenvolvo projetos como o Bikcraft e Buscador de Cep utilizando{' '}
          <strong>HTML</strong> , <strong>CSS</strong>,{' '}
          <strong>JavaScript</strong> e <strong>ReactJs</strong>. Para o meu
          desenvolvimento e experiência tenho alguns projetos que desenvolvi
          durante os meus estudos na área.
        </p>

        <div className="empresa">
          <span className="empresa-ano">2022</span>
          <h3 className="empresa-titulo">
            <a
        ...
        <div className="empresa">
          ...
          <h3 className="empresa-titulo">
            <a
              href="https://mauricioc08.github.io/Clone_instagram/"
              target="_blank"
              rel="noreferrer"
            >
              Clone-Instagran
          ...
          <span className="empresa-titulo">Desenvolvedor Front-End</span>
          <p className="empresa-texto">
            No projeto Clone-Instagran eu trabalhei no desenvolvimento de uma
            pagina inicial de login do instagran.
          </p>
          <ul className="empresa-habilidades">
